...
set extName=browser_file_tools
set dllName=browser_file_tools
set gmlDir14=%solutionDir%browser_file_tools.gmx
set gmlDir22=%solutionDir%browser_file_tools_yy
set gmlDir23=%solutionDir%browser_file_tools_23
